...
const Animator = (props) => {
    ...
    useEffect(() => {
        if (props?.animation && !animation?.incoming) {
            setAnimation({...JSON.parse(props?.animation), incoming: true});
            ...
            data: {
                frames: {
                    ...
                    [animation?.currentFrame ? animation?.currentFrame : '']: {
                        ...(animation?.frames ? animation?.frames : {})[animation?.currentFrame ? animation?.currentFrame : ''],
                        [`${
                            Object?.keys((animation?.frames ? animation?.frames : {})[animation?.currentFrame ? animation?.currentFrame : ''])?.length
                        }_${Math.random()?.toString()?.slice(2, 8)}_frame_element`]: {
                            left: '0px',
                            top: '0px',
                            height: '50px',
                            width: '50px',
    ...
    return animation?.incoming !== undefined ? (
        <>
            <div
                id={`animator_main_container`}
                className={`animator_main_container`}
            ...
            >
                {!animation?.incoming ? (
                    <div className={`toolbar_container`}>
                        <div className={`frames_container`}>
                            <div className={`custom_style canvas_option`}>
                                <div
                                    className={`canvas_click text_container`}
                                    onClick={() => {
                                        handleClickOutside();
                                ...
                                >
                                    ...
                                    <span id={`canvas_scale`}>
                                        {parseInt(animation?.scale ? animation?.scale : '10') !== 10
                                            ? `x${parseInt(animation?.scale ? animation?.scale : '10') / 10}`
                                            : ''}
                                    </span>
                                </div>
                                {animation?.openCanvasOption ? (
                                    <div className={`canvas_actions_container`}>
                                        <div className={`canvas_click custom_style`}>
                                            <div className={`canvas_click text_container`}>ANCHO:</div>
                                            <input
                                        ...
                                        <div className={`canvas_click custom_style`}>
                                            <div className={`canvas_click text_container`}>ALTURA:</div>
                                            <input
                                                type="text"
                                                className={`canvas_click`}
                                        ...
                                        <div className={`canvas_click custom_style`}>
                                            <div className={`canvas_click text_container`}>TIEMPO:</div>
                                            <input
                                                className={`canvas_click`}
                                                type="text"
                                        ...
                                        <div className={`canvas_click custom_style`}>
                                            <div className={`canvas_click text_container`}>COLOR:</div>
                                            <input
                                                className={`canvas_click`}
                                                type="text"
                                        ...
                                        <div
                                            className={`custom_style ${animation?.interval ? 'active' : ''}`}
                                            onClick={() => (animation?.interval ? {} : handlePlay())}
                                        >
                                            <div className={`canvas_click text_container`}>PLAY</div>
                                        </div>
                                        <div className={`custom_style`} onClick={() => handlePause()}>
                                            <div className={`canvas_click text_container`}>PAUSE</div>
                                        </div>
                                        <div className={`custom_style`} onClick={() => handleSave()}>
                                            <div className={`canvas_click text_container`}>GUARDAR</div>
                                        </div>
                                    </div>
                                ) : null}
                            </div>
                            <div
                                id={`frames_scroll`}
                                className={`frames_scroller frames_scroll custom_horizontal_scroll`}
                                onMouseOver={() => window.addEventListener('wheel', handleSideScroll)}
                                onMouseLeave={() => window.removeEventListener('wheel', handleSideScroll)}
                            >
                                {animation?.frames &&
                                    Object.values(animation?.frames)?.map((_frame, index) => (
                                        <div
                                            key={`frame_${index}`}
                                            className={`frames_scroller custom_style frame_${index} ${
                                                animation?.currentFrame === `frame_${index}` ? 'active' : ''
                                            }`}
                                        >
                                            <div
                                                className={`frames_scroller text_container`}
                                                onClick={() =>
                                                    handleUpdateAnimation({data: {currentElement: undefined, currentFrame: `frame_${index}`}})
                                                }
                                            >
                                                frame {index + 1}
                                            </div>
                                            {index > 0 ? (
                                                ...
                                                >
                                                    <div className={`frames_scroller cover`} />X
                                                </div>
                                            ) : null}
                                        </div>
                                    ))}
                            ...
                            <div
                                className={`frames_scroller create_next_frame`}
                                onClick={() => handleCreateFrame({name: `frame_${Object.keys(animation?.frames ? animation?.frames : {})?.length}`})}
                            >
                                <div className={`frames_scroller text_container`}>+</div>
                            </div>
                        </div>
                        <div className={`elements_container`}>
                            <div
                                id={`elements_scroll`}
                                className={`elements_scroller elements_scroll custom_horizontal_scroll`}
                                onMouseOver={() => window.addEventListener('wheel', handleSideScroll)}
                                onMouseLeave={() => window.removeEventListener('wheel', handleSideScroll)}
                            >
                                {animation?.frames &&
                                    Object.keys(animation?.frames[animation?.currentFrame ? animation?.currentFrame : ''])?.map((element) => (
                                        <div className={`elements_scroller custom_style ${animation?.currentElement === element ? 'active' : ''}`}>
                                            ...
                                            <div className={`elements_scroller close_button`} onClick={() => handleDeleteElement(element)}>
                                                <div className={`elements_scroller cover`} />X
                                            </div>
                                        </div>
                                    ))}
                            </div>
                            <div className={`create_next_frame`} onClick={() => handleCreateElement()}>
                                <div className={`text_container`}>+</div>
                            </div>
                        </div>
                        {animation?.currentElement ? (
                            <div className={`edit_container`}>
                                <div className={`close_button`} onClick={() => handleUpdateAnimation({data: {currentElement: undefined}})}>
                                    X
                                </div>
                                <div>Elemento: {animation?.currentElement?.split('_')[0]}</div>
                                <Select
                                    ...
                                    attribute !== 'transform' ? (
                                        <div className={`edit_element`}>
                                            ...
                                            <input
                                                ...
                                                //@ts-ignore
                                                value={
                                                    animation?.frames && animation?.currentFrame && animation?.currentElement
                                                        ? animation?.frames[animation?.currentFrame][animation?.currentElement][attribute]
                                                        : undefined
                                                }
                ...
                <div
                    id={'animator_canvas'}
                    className={`animator_canvas`}
                    style={{
                        width: animation?.canvasWidth,
                        height: animation?.canvasHeight,
                        transform: `scale(${parseInt(animation?.scale || '10') / 10})`,
                        backgroundColor: animation?.canvasColor,
                    }}
                ...
                >
                    {animation?.currentFrame &&
                        ...
                        Object.keys(animation?.frames[animation?.currentFrame])?.map((element) => (
                            <div
                                id={element}
                                className={`${element} ${animation?.currentElement === element ? 'active' : ''}`}
                                ...
                                onClick={(event) =>
                                    animation?.incoming
                                        ? {}
                                        : handleUpdateAnimation({
                                              data: {currentElement: animation?.currentElement === element ? undefined : event?.target?.classList[0]},
                                          })
                                }
                                style={{
                                    ...(animation?.frames ? animation?.frames : {})[animation?.currentFrame ? animation?.currentFrame : ''][element],
                                    ...(animation?.incoming ? {cursor: 'default'} : {}),
                                }}
                            />
                        ))}
                    {!animation?.incoming && animation?.currentElement ? (
                        <div
                            className="element_pointer"
                            style={{
                                top: (animation?.frames ? animation?.frames : {})[animation?.currentFrame ? animation?.currentFrame : ''][
                                    animation?.currentElement
                                ]?.top,
                                left: (animation?.frames ? animation?.frames : {})[animation?.currentFrame ? animation?.currentFrame : ''][
                                    animation?.currentElement
                                ]?.left,
                                width: (animation?.frames ? animation?.frames : {})[animation?.currentFrame ? animation?.currentFrame : ''][
                                    animation?.currentElement
                                ]?.width,
                                height: (animation?.frames ? animation?.frames : {})[animation?.currentFrame ? animation?.currentFrame : ''][
                                    animation?.currentElement
                                ]?.height,
                            }}
                        />
